...
final class ApolloClientOperationTests: XCTestCase {
  ...
  class MockStore: ApolloStore {
    ...
    override func publish(records: RecordSet, identifier: UUID? = nil, requestContext: RequestContext? = nil, callbackQueue: DispatchQueue = .main, completion: ((Result<Void, Swift.Error>) -> Void)? = nil) {
